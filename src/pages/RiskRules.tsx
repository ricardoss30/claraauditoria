...
import { Shield, Plus, Pencil, Trash2, Tags, ListTree } from "lucide-react";
...
export default function RiskRules() {
  ...
  const { categories, types, addCategory, deleteCategory, addType, deleteType } = useRuleOptions("risk");
