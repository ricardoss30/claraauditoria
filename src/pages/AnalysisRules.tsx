    ...
    <AppLayout>
      <div className="space-y-6">
        ...
        {isLoading ? (
          ...
          <EmptyState icon={FileSearch} title="Nenhuma regra de análise cadastrada" description="Configure regras de análise para orientar a avaliação dos documentos." />
        ) : (
        ...
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          <DialogContent>
            <DialogHeader><DialogTitle>{editId ? "Editar Regra" : "Nova Regra de Análise"}</DialogTitle></DialogHeader>
