...
INSTRUÇÃO IMPORTANTE: Incorpore obrigatoriamente os critérios acima na seção "5. Contextualização da Situação Auditada" (campo contextualizacao) e na seção "7. Constatações/Achados e Evidências" (campo constatacoes). As constatações devem refletir a aplicação direta da metodologia e técnicas descritas pelo auditor, detalhando os achados conforme cada critério especificado.` : ""}
